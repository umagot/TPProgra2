...
Estructuras de datos utilizadas: Hasta la segunda entrega: diccionarios, grafos (matriz de adyacencias) y listas enlazadas. Luego implementaremos arboles, pilas y colas para las siguientes funcionalidades.

Funcionalidades implementadas en esta segunda etapa: Identificación inmediata, Red de Contactos y Jerarquía de habilidades (esta última parcialmente implementada) 
